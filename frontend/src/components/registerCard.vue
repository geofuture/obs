  ...
  <v-card width="400" class="mx-auto mt-5">
    ...
    <v-card-text>
      <v-form ref="formRegister" v-model="valid" lazy-validation>
        ...
        />
        <p class="overline">
          Ingresa tu correo electŕonico. Este será tratado como tu nombre de
          usuario
        </p>
        <v-text-field
      ...
      <p class="overline">
        Asigna una contraseña a tu cuenta. debe tener mínimo 6 caractéres sin
        espacios ni símbolos especiales
      </p>
    </v-card-text>
    <v-divider></v-divider>
    <v-card-actions>
      <v-btn class="white--text" color="blue-grey darken-3" to="/login"
        >Volver</v-btn
      >
      <v-spacer></v-spacer>
      <v-btn
