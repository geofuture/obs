  ...
  <v-dialog v-model="dialog" width="80%" persistent>
    <template v-slot:activator="{ on }">
      <v-card width="80%" class="mx-auto mt-5 mb-5">
        ...
        <v-card-text>
          <p class="overline">
            Asigna un nombre y una descripción al nuevo proyecto
          </p>
          ...
          <v-card-actions>
            <v-btn class="white--text" color="blue-grey darken-3" to="/"
              >Regresar
            </v-btn>
            <v-spacer></v-spacer>
            <v-btn
    ...
    <v-card class="mx-auto">
      ...
      <v-card-text>
        <p class="overline">
          Agrega campos al formulario de tu nuevo proyecto. Define nombre y tipo
          de dato
        </p>
        <v-form v-model="validField">
          <v-row>
            <v-col cols="9" sm="3">
              <v-text-field v-model="label" label="Nombre Campo" required>
              </v-text-field>
            </v-col>
            <v-col cols="9" sm="3">
              <v-select
